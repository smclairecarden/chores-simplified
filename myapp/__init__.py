...
app.config['SQLALCHEMY_DATABASE_URI'] = "postgresql://localhost:5432/chores"
...
# Linking and registering chores views Blueprint
from myapp.chores.views import chores
